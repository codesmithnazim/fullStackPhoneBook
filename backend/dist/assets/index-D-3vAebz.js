...
var wr = `/api/persons`,
  Tr = {
    ...
    updateNumber: (e, t) => F.put(`${wr}/${e}`, t).then((e) => e.data),
    addPerson: (e) => F.post(`/api/persons`, e),
  };
function Er({
  persons: e,
  setRefresh: t,
  setGreenNotification: n,
  setRedNotification: r,
}) {
  let [i, a] = (0, m.useState)({ name: ``, number: `` });
  return (0, h.jsxs)(`form`, {
    onSubmit: (o) => {
      if ((o.preventDefault(), e.some((e) => e.name === i.name)))
        if (
          window.confirm(
            `${i.name} is already added to phonebook , Do you wanna replace old number with the new  number`,
          )
        ) {
          let n = e.find((e) => e.name === i.name).id;
          (console.log(`Ok, we are replacing.... and the id giver = `, n),
            Tr.updateNumber(n, i).then((e) => t((e) => !e)));
          return;
        } else return;
      if (e.some((e) => e.number === i.number)) {
        (r(`${i.number} is already exist in the phonebook `),
          setTimeout(() => {
            r(``);
          }, 2500));
        return;
      ...
      (Tr.addPerson(i)
        .then((e) => {
          (n(`User is added successfully ....`),
            t((e) => !e),
            console.log(`the responce we get fromt he post req = `, e),
            setTimeout(() => {
              n(``);
            }, 3e3));
        })
        .catch((e) =>
          console.log(`the error we got from the post request `, e),
        ),
        a((e) => ({ ...e, name: ``, number: `` })));
    },
    children: [
      ...
      (0, h.jsx)(`button`, {
        onClick: (r) => {
          window.confirm(
            ...
            Tr.deletePerson(e.id)
              .then((r) => {
                (t((t) => t.filter((t) => t.id != e.id)),
                  n(
        ...
        children: [
          ...
          (0, h.jsx)(`ul`, {
            ...
            children: i.map((e) =>
              (0, h.jsx)(
                Dr,
                { person: e, setPersons: t, setNegativeNotification: l },
                e.id,
              ),
            ),
          }),
